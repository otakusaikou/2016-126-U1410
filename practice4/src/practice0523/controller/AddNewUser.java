package practice0523.controller;
...
import practice0523.model.AccountUtil;
import practice0523.model.User;
...
public class AddNewUser extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		if ("完成".equals(page)) {
            ...
            /*Create user object*/
            User user = AccountUtil.addNewUser(name, address, phoneNumber, education);
